...
def measure():
    ...
    amount_sockets = [4]  # , 2, 4, 8, 16, 32, 64, 120]
    mean_data = []
    ...
    for current_amount_sockets in amount_sockets:
        ...
        for index in range(0, current_amount_sockets):
            ...
            pifus_sock_data = framework.ts_to_latency_time_tuple(
                pifus_tx_file, pifus_txed_file, "pifus", warmup_count=1000)
            ...
            netconn_data += framework.ts_to_latency_time_tuple(
                netconn_tx_file, netconn_txed_file, "netconn", warmup_count=1000)
        ...
        mean_data.append(["lwip", current_amount_sockets,
    ...
    # TODO: maybe also save stddev, 30%, etc.
